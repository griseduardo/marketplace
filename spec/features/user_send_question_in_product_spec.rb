...
feature 'User send question in product' do
  scenario 'must be logged in to send question' do
  ...
  scenario 'must have profile to send question' do
    Company.create!(name: 'Rotes', cnpj: '96.672.638/0001-48', domain: 'rotes.com')
    user1 = User.create!(email: 'eduardo@rotes.com', password: '120456')
    user2 = User.create!(email: 'carol@rotes.com', password: '123456')
    department2 = Department.create!(name: 'Vendas')
    ...
    expect(page).not_to have_content('Adicionar pergunta')
  end

  scenario 'must not be product seller to send question' do
    Company.create!(name: 'Rotes', cnpj: '96.672.638/0001-48', domain: 'rotes.com')
    user2 = User.create!(email: 'carol@rotes.com', password: '123456')
    department2 = Department.create!(name: 'Vendas')
    profile2 = Profile.create!(full_name: 'Edgar Gomes', chosen_name: 'Carol Gomes', birthday: '10/08/1990', 
    ...
    expect(page).not_to have_content('Enviar pergunta')
  end
  ...
  scenario 'successfully' do
    ...
    visit root_path
    click_on 'Adidas Fevernova - Bola da copa de 2002'
    fill_in 'Pergunta', with: 'Tem alguma marca na bola?'
    ...
    expect(page).to have_content('Tem alguma marca na bola?')
  end

  scenario 'must fill in question' do
    Company.create!(name: 'Rotes', cnpj: '96.672.638/0001-48', domain: 'rotes.com')
    user1 = User.create!(email: 'eduardo@rotes.com', password: '120456')
    user2 = User.create!(email: 'carol@rotes.com', password: '123456')
    department1 = Department.create!(name: 'RH')
    ...
    expect(page).to have_content('Faltou preencher pergunta')
    expect(page).not_to have_content('Eduardo Rodrigues')
